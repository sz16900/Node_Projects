...
module.exports = "<h2 class=\"page-heaedr\">Dashboard</h2>\n<p>Welcome to your Dashboard brov!</p>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashMessagesService.show('You are now logged in mate!', {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashMessagesService.show("Something has gone horribly wrong!", { cssClass: 'alert-danger', timeout: 3000 });
                // To re-direct we need to bring the router
